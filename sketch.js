...
function setup() {
	...
	bob1=new Ball (410,550)
	bob2=new Ball (260,550)
	bob3=new Ball (290,550)
	bob4=new Ball (350,550)
...
function keyPressed(){
	...
	bob2.body.position.x = bob2.body.position.x-5
	bob2.body.position.y =bob2.body.position.y-5
	}
	}
